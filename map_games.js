...
//	var circle = the_place.circle;
        // move map
	console.log("in mmtp, frame_center: " + the_place.frame_center.lat + "  " + the_place.frame_center.lng);
	console.log("in mmtp, frame_center: " + JSON.stringify(the_place.frame_center.latlng));
        map.setCenter(the_place.frame_center.latlng);
	console.log("AAA. map center: " + JSON.stringify(map.getCenter()));
        // adjust zoom level
	console.log("the place name, zoom: " + the_place.name + "  " + the_place.zoom);
